...
class Player:
    ...
    def update_position(self, row_coord, col_coord, place_num, old_pos, new_pos, place_id, prop_obj_id, chance, player_name, client):
    ...
    def status_frame_display(self, sf_width, sf_height):
        ...
        self.sf_height = sf_height
        
        # display smaller frame inside our stat box
        self.inferior_status_frame = tk.LabelFrame(stat_box, text=self.name, bg="tomato", relief="flat",
                                                   width= sf_width/len(data_holder["players list"]), height=sf_height,
                                                   font=("white", 13), bd=7)
