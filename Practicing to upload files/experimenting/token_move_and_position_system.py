# this is the original file of our tkinter version of moving token
...
tkinter.Frame(window, width=150, height=60, relief=tkinter.RIDGE, bg="blue", highlightbackground="black",
...
import keyboard
keyboard.add_hotkey('shift+d',lambda:roll_dice())
...
#token1 = tkinter.Label(window,text="T1").grid(row=10,column=10)
