...
def step_5(main_frame, font1,n_players,properties_dicto):
    ...
    class roll_dice_class():
        ...
        def __init__(self):
            ...
            global roll_dice_d
            roll_dice_d = tk.Button(main_frame, text="Roll Dice!", bg="orange" ,font=font1, command=lambda: self.virtual_dice())
        ...
        def virtual_dice(self):
            ...
            tk.Label(main_frame, textvariable=show_dice, bg="green", fg="orange", width=12, height=2).grid(row=7,column=5)
