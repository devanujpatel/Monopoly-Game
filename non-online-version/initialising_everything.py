# will conatain som vital info necessary for gameplay-- imp fo save feature
master_dictionary = {}
# default colors - Not necessary for save feature
...
# contains a list of playing tokens acc to n_players -- imp fo save feature
playing_tokens = []
# all colors supported by tkinter --not imp fo save feature
...
# includes names of players (asked in the beginning if game ) default if player1(for example) -- imp for save feature
...
# depend on n_players hence imp for save feature-----will contain a list of objects of the token class for calling attributes later
playing_token_obj_id = []

# used in ask frame class - to check if all players have entered their details
asf_x = 0
asf_y = 0
